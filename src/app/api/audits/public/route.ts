...
export async function POST(req: NextRequest) {
  ...
  try {
    // Insert audit (share_id is auto-generated by database)
    const { data: audit, error: auditError } = await supabase
      .from("audits")
      .insert({
        organization_id: "00000000-0000-0000-0000-000000000000",
        title,
        provider: result.providersScanned.join(", "),
        total_monthly_spend: result.totalCurrentSpend,
        total_annual_spend: result.totalCurrentSpend * 12,
    ...
    return NextResponse.json(
      {
        ...
        shareUrl: `${req.nextUrl.origin}/results/${audit.share_id}`,
        result,
      },
      { status: 201 }
    );
